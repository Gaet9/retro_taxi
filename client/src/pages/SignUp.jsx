...
export const SignUp = () => {
    ...
    return (
        <div className='bg-butter bg-cover h-screen racing-font overflow-y-auto overflow-x-hidden'>
            ...
            {NotificationElement}
            <form id='signup-form-id' className='flex justify-center m-5'>
                <div
                    ...
                    <div className='flex flex-row justify-center'>
                        <div className='flex flex-col m-5 w-2/3'>
                            ...
                            <div className='relative m-5 group'>
                                ...
                                <i className='absolute left-5 top-2.5 fa-solid fa-circle-user fa-md px-1 text-purple-950 transition-all duration-200 ease-in-out group-focus-within:-translate-x-3'></i>
                            </div>
                            {/* Email field  */}
                            <div className='relative m-5 group'>
                                <input
                                ...
                                <i className='absolute left-5 top-2.5 fa-solid fa-at fa-md px-1 text-purple-950 transition-all duration-200 ease-in-out group-focus-within:-translate-x-3'></i>
                            ...
                            <div className='relative m-5 group'>
                                ...
                                <i className='absolute left-5 top-2.5 fa-solid fa-key fa-md px-1 text-purple-950 transition-all duration-200 ease-in-out group-focus-within:-translate-x-3'></i>
                                <button
                                    type='button'
                                    onClick={() => setShowPassword(!showPassword)}
                                    className='absolute right-5 top-2 text-purple-950 hover:text-purple-800 transition-all duration-200 ease-in-out group-focus-within:translate-x-3'>
                                    <i className={`fa-solid ${showPassword ? "fa-eye" : "fa-eye-slash"} fa-md`}></i>
                                </button>
                            </div>
                            ...
                            <div className='relative m-5 group'>
                                ...
                                <label className='absolute -top-7 left-O text-md text-purple-950'>Confirm password</label>
                                <i className='absolute left-3 top-2 fa-solid fa-key fa-md px-1 text-purple-950 transition-all duration-200 ease-in-out group-focus-within:-translate-x-3'></i>
                                <i className='absolute left-5 top-3.5 fa-solid fa-key fa-md fa-flip-both px-1 text-purple-500 transition-all duration-200 ease-in-out group-focus-within:-translate-x-3'></i>
                                <button
                                    type='button'
                                    onClick={() => setShowConfirmPassword(!showConfirmPassword)}
                                    className='absolute right-5 top-2 text-purple-950 hover:text-purple-800 transition-all duration-200 ease-in-out group-focus-within:translate-x-3'>
                                    <i className={`fa-solid ${showConfirmPassword ? "fa-eye" : "fa-eye-slash"} fa-md`}></i>
                                </button>
                            </div>
                            ...
                            <div className='relative m-5 group'>
                                ...
                                <label className='absolute -top-7 left-O text-md text-purple-950'>Role</label>
                                <i className='absolute left-5 top-2.5 fa-solid fa-user-tag fa-md px-1 text-purple-950 transition-all duration-200 ease-in-out group-focus-within:-translate-x-3'></i>
                            </div>
                        </div>
                    </div>
                    <div className='flex w-full justify-around items-center pb-5'>
                        ...
                        <div className='flex items-center space-x-3'>
                            ...
                            />
                            <label htmlFor='newsletter-signup-id' className='text-lg text-purple-950'>
                        ...
                        <button
                            ...
                            className={`flex justify-center items-center 
                             px-20 py-2 text-xl text-butter 
